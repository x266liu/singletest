...
class TC_1_Class(object):
    ...
    def run_TC_1(self, elemetnAttributeDictionary):
        ...
        for INDEX in range(numberOfVideos):
            ...
            videoCommandList = [os.path.join(fp.paths.sqmLibApplication), "-i", os.path.join(fp.paths.testDataDir,"1-Resolutions",subdir, inputVideosList[INDEX])]  
