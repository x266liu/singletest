...
class TC_9_Class(object):
    ...
    def run_TC_9(self, elemetnAttributeDictionary):
        ...
        generateTestResultFile.testResultObject.writeInTestFile(",,Test and verify different QA-Features videos:\n")
        ...
        for INDEX in range(numberOfVideos):
            ...
            videoCommandList = [os.path.join(fp.paths.sqmLibApplication), "-i", os.path.join(fp.paths.testDataDir,"9-QA_Features",subdir, inputVideosList[INDEX])]  
