...
class TC_7_Class(object):
    ...
    def run_TC_7(self, elemetnAttributeDictionary):
        ...
        generateTestResultFile.testResultObject.writeInTestFile(",,Test and verify different Duration videos:\n")
        ...
        for INDEX in range(numberOfVideos):
            ...
            videoCommandList = [os.path.join(fp.paths.sqmLibApplication), "-i", os.path.join(fp.paths.testDataDir,"7-Durations",subdir, inputVideosList[INDEX])]  
