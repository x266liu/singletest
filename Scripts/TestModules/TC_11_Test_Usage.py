...
class TC_11_Class(object):
    ...
    def run_TC_11(self, elemetnAttributeDictionary):
        ...
        generateTestResultFile.testResultObject.writeInTestFile(",,Test and verify different Usage videos:\n")
        ...
        for INDEX in range(numberOfVideos):
            ...
            videoCommandList = [os.path.join(fp.paths.sqmLibApplication), "-i", os.path.join(fp.paths.testDataDir,"11-Usages",subdir, inputVideosList[INDEX])]  
