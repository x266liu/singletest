...
class TC_13_Class(object):
    ...
    def run_TC_13(self, elemetnAttributeDictionary):
        ...
        generateTestResultFile.testResultObject.writeInTestFile(",,Test and verify different Spainish videos:\n")
        ...
        for INDEX in range(numberOfVideos):
            ...
            videoCommandList = [os.path.join(fp.paths.sqmLibApplication), "-i", os.path.join(fp.paths.testDataDir,"13-Spainish",subdir, inputVideosList[INDEX])]  
