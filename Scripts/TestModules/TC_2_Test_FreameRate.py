...
class TC_2_Class(object):
    ...
    def run_TC_2(self, elemetnAttributeDictionary):
        ...
        generateTestResultFile.testResultObject.writeInTestFile(",,Test and verify different FrameRate videos videos:\n")
        ...
        for INDEX in range(numberOfVideos):
            ...
            videoCommandList = [os.path.join(fp.paths.sqmLibApplication), "-i", os.path.join(fp.paths.testDataDir,"2-FrameRate",subdir, inputVideosList[INDEX])]  
